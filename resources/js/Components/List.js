    ...
    return (
        <ul className="list-group">
            {pokemons.map((pokemon) => (
                <li className="list-group-item d-flex justify-content-between align-items-center text-capitalize cursor" key={pokemon.id} onClick={() => setPokemonSelected(pokemon)}>
                    {pokemon.name}
